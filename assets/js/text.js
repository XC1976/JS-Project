...
let textePrairieFinie =
  "Je n'ai plus rien à faire ici. Je ferais mieux d'aller voir la batisse ou de retourner en arrière !";

let textePrairieMort =
...
let texteBatBouclier =
  "La cheminée en pierre s'ouvre lentement, révélant une cachette secrète. À l'intérieur se trouve un bouclier en acier, que le héros ajoute à son inventaire. Le héros est désormais mieux protégé pour le combat final contre l'ogre.";

let texteBatFini =
  "Je n'ai plus rien à faire ici. Il va être temps d'aller voir ce qu'il se passe dans la grotte !";
...
let texteMagicienLumiere =
  "Le magicien sourit et vous tend un objet magique lumineux (orbe de lumière), ajouté à votre inventaire. Il explique que cet objet permettra d'éclairer la caverne et d'éviter les pièges. Le héros redescend en bas de la tour.";

let texteMagicienMort =
  "Le visage du magicien se tord, son rire devient hystérique. Il pousse soudain le héros du balcon. Le héros meurt de la chute, fin dramatique immédiate.";
...
let texteGrotteLumiere =
  "La caverne s'illumine grâce à l'objet lumineux. Vous pouvez voir clairement le chemin, éviter les pièges et avancer sans encombre. La progression vers le cœur de la caverne et l'ogre devient possible.";

let texteGrotteMort =
  "L'obscurité totale vous empêche de voir quoi que ce soit. Vous avancez, mais votre pied heurte un trou rempli de pics en bois que vous ne pouviez pas voir. Vous tombez et êtes mortellement blessé, vous êtes mort !";
...
let texteOgreSansArme =
  "Le héros tente de se défendre, mais il est complètement désarmé. L'ogre l'attrape sans effort, le ligote et le place dans la marmite avec la fille du forgeron.";

let texteOgreSansBouclier =
  "Le héros frappe de toutes ses forces avec son épée. L'ogre esquive habilement et riposte d'un violent coup de massue, tuant instantanément le héros !";